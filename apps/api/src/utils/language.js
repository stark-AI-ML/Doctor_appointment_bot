...
export class LanguageService {
  constructor(defaultLang = 'hi') {
    ...
    this.dictionary = {
      ...
      'Laparoscopic & General Surgery': 'लेप्रोस्कोपिक एवं सामान्य शल्य चिकित्सा',
  ...
  getTranslation(englishText, dbHindiValue = null) {
    if (dbHindiValue && typeof dbHindiValue === 'string' && dbHindiValue.trim()) {
   ...
   */
  formatDoctor(doctor = {}) {
    const name = doctor.name ? `Dr. ${doctor.name}` : ''
    const nameHindi = doctor.nameHindi ? `डॉ. ${doctor.nameHindi}` : ''
